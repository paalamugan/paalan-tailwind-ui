...
<ColorPalette>
  ...
  <ColorItem
    title="info"
    subtitle="Used for info actions such as <Button variant='info'>"
    colors={{
  ...
  <ColorItem
    title="warning"
    subtitle="Used for warning actions such as <Button variant='warning'>"
    colors={{
  ...
  <ColorItem
    title="success"
    subtitle="Used for success actions such as <Button variant='success'>"
    colors={{
  ...
  <ColorItem
    title="danger"
    subtitle="Used for danger actions such as <Button variant='danger'>"
    colors={{
