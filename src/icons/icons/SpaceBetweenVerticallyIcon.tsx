...
const SpaceBetweenVertically = React.forwardRef<SVGSVGElement, IconProps>(
...
export const SpaceBetweenVerticallyIcon = convertSvgIconToIcon(SpaceBetweenVertically);
