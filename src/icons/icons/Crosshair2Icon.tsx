...
const Crosshair2 = React.forwardRef<SVGSVGElement, IconProps>(({ color = 'currentColor', ...props }, forwardedRef) => {
  return (
    <svg
      width="15"
      height="15"
...
export const Crosshair2Icon = convertSvgIconToIcon(Crosshair2);
