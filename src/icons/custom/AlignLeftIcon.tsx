...
const AlignLeft = React.forwardRef<SVGSVGElement, IconProps>(({ color = 'currentColor', ...props }, forwardedRef) => {
  return (
    <svg
      width="15"
      height="15"
...
export const AlignLeftIcon = convertSvgIconToIcon(AlignLeft);
